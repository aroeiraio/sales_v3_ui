...
<head>
    ...
    <title>POS System - Pinpad Instructions V1</title>
    <style>
:root {
  ...
  --spacing: 1rem;
    ...
    <style>
        ...
        * {
        ...
        /* Instructions card with new design */
        .instructions-card {
            background: var(--card);
        ...
        /* Amount display with new design */
        .amount-display {
            text-align: center;
            margin-bottom: 3rem;
            padding: 2rem;
...
<body>
    ...
    <main class="main-content">
        <div class="instructions-card">
            ...
            <div class="amount-display">
                ...
                <div class="amount-value">R$ 19,50</div>
            </div>
    ...
    <script>
        ...
        // Demo: Simulate step progression
        let currentStep = 0;
